...
*/
			...
			renderHTML : function(){
				var html = '<div class="mt_mask"></div>' +
					...
					'<div class="mt_panel"><h3 class="mt_title">请选择时间</h3>' +
					'<div class="mt_body"><div class="mt_date">' +
					'<ul><li class="mt_note">上下滚动选取时间</li><li></li></ul>' +
					'</div><div class="mt_time"><ul><li></li></ul></div>' +
					'<div class="mt_indicate"></div></div>' +
					'<div class="mt_confirm"><a href="javascript:void(0);" class="mt_ok">确定</a> <a href="javascript:void(0);" class="mt_cancel">取消</a></div></div>' +
					'</div>';
